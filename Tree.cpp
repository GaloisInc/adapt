...
//Randomly pick an attribute and a split point
 ...
 this->splittingAtt = attributes[randomI(0,attributes.size())];
 this->splittingPoint =(double) rand()/(RAND_MAX+1) *(minmax[1][this->splittingAtt] - minmax[0][this->splittingAtt]);
 //Create sub-treee
