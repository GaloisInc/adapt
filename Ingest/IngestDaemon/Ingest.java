...
public class Ingest {
    public static void main(String[] args) throws IOException {
        List<TCCDMDatum> cdmData = readAvroFile("test.avro");

        Stopwatch timer = Stopwatch.createStarted();
        insertIntoTitan(cdmData);
    ...
    //private static CDMData readAvroFile(String file) throws IOException {
    ...
    private static void insertIntoTitan(List<TCCDMDatum> dataList) {
        ...
        for(TCCDMDatum data : dataList) {
            ...
            v.property("properties", data.getDatum());
        }
