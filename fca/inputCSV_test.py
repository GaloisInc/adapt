...
r1=tests.test_inputfiles(proc_event_cadets_bovia,'./fca/contextSpecFiles/neo4jspec_ProcessEvent.csv')
...
if r1==0:
	...
	r2=tests.test_inputfiles(proc_byIPPort_cadets_bovia,'./fca/contextSpecFiles/neo4jspec_ProcessByIPPort.csv')
	if r2==0:
		print('\nSECOND TEST PASSED')
