...
#
CLASSPATH="$CLASSPATH:${PRE}common/vendor/lib/xerces.jar"
CLASSPATH="$CLASSPATH:${PRE}common/vendor/lib/xml-apis.jar"
CLASSPATH="$CLASSPATH:${PRE}common/vendor/lib/jdom.jar"
#
