...
public class Interface extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -354700319720006207L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Interface\",\"namespace\":\"com.bbn.tc.schema.avro.cdm18\",\"doc\":\"Interface name and addresses\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"macAddress\",\"type\":\"string\"},{\"name\":\"ipAddresses\",\"type\":{\"type\":\"array\",\"items\":\"string\"}}]}");
   ...
   */
  public static com.bbn.tc.schema.avro.cdm18.Interface.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm18.Interface.Builder();
  }
   ...
   * @return A new Interface RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.Interface.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.Interface.Builder other) {
    return new com.bbn.tc.schema.avro.cdm18.Interface.Builder(other);
  }
   ...
   * @return A new Interface RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.Interface.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.Interface other) {
    return new com.bbn.tc.schema.avro.cdm18.Interface.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Interface>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.Interface.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.Interface other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Interface.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Interface.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Interface.Builder setMacAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Interface.Builder clearMacAddress() {
      macAddress = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Interface.Builder setIpAddresses(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Interface.Builder clearIpAddresses() {
      ipAddresses = null;
