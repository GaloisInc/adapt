...
public class CryptographicHash extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CryptographicHash(com.bbn.tc.schema.avro.cdm19.CryptoHashType type, java.lang.CharSequence hash) {
    this.type = type;
    this.hash = hash;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (com.bbn.tc.schema.avro.cdm19.CryptoHashType)value$; break;
   ...
   */
  public com.bbn.tc.schema.avro.cdm19.CryptoHashType getType() {
    return type;
  }
   ...
   */
  public void setType(com.bbn.tc.schema.avro.cdm19.CryptoHashType value) {
    this.type = value;
  }
   ...
   */
  public static com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder();
  }
   ...
   * @return A new CryptographicHash RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder other) {
    return new com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder(other);
  }
   ...
   * @return A new CryptographicHash RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.CryptographicHash other) {
    return new com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CryptographicHash>
    ...
    /** The type of hash used */
    private com.bbn.tc.schema.avro.cdm19.CryptoHashType type;
    /** The base64 encoded hash value */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.CryptographicHash other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder setType(com.bbn.tc.schema.avro.cdm19.CryptoHashType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder setHash(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.CryptographicHash.Builder clearHash() {
      hash = null;
