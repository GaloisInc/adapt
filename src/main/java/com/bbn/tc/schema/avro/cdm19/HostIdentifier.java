...
public class HostIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder();
  }
   ...
   * @return A new HostIdentifier RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder other) {
    return new com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder(other);
  }
   ...
   * @return A new HostIdentifier RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.HostIdentifier other) {
    return new com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HostIdentifier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.HostIdentifier other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.idType)) {
        this.idType = data().deepCopy(fields()[0].schema(), other.idType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder setIdType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder clearIdType() {
      idType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder setIdValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.HostIdentifier.Builder clearIdValue() {
      idValue = null;
