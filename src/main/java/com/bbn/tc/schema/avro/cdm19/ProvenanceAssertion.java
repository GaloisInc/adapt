...
public class ProvenanceAssertion extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.bbn.tc.schema.avro.cdm19.UUID> sources;
   ...
   * @param provenance * Further provenance assertions within this assertion.
	 ...
	 * e.g.,
         * "X asserts that Y asserts that Z comes from {p,q}".
   */
  public ProvenanceAssertion(com.bbn.tc.schema.avro.cdm19.UUID asserter, java.util.List<com.bbn.tc.schema.avro.cdm19.UUID> sources, java.util.List<com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion> provenance) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: asserter = (com.bbn.tc.schema.avro.cdm19.UUID)value$; break;
    case 1: sources = (java.util.List<com.bbn.tc.schema.avro.cdm19.UUID>)value$; break;
    case 2: provenance = (java.util.List<com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.bbn.tc.schema.avro.cdm19.UUID getAsserter() {
    return asserter;
  }
   ...
   */
  public void setAsserter(com.bbn.tc.schema.avro.cdm19.UUID value) {
    this.asserter = value;
  }
   ...
   */
  public java.util.List<com.bbn.tc.schema.avro.cdm19.UUID> getSources() {
    return sources;
  }
   ...
   * @param value the value to set.
   */
  public void setSources(java.util.List<com.bbn.tc.schema.avro.cdm19.UUID> value) {
    this.sources = value;
  }
   ...
   */
  public static com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder();
  }
   ...
   * @return A new ProvenanceAssertion RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder other) {
    return new com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder(other);
  }
   ...
   * @return A new ProvenanceAssertion RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion other) {
    return new com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProvenanceAssertion>
    ...
    /** Which Subject is making this assertion? */
    private com.bbn.tc.schema.avro.cdm19.UUID asserter;
    /** Object(s) that this Value's data came from. */
    private java.util.List<com.bbn.tc.schema.avro.cdm19.UUID> sources;
    /** * Further provenance assertions within this assertion.
	 * For example, to describe a situation in which X asserts that
	 * Y asserts that Z asserts that V came from {p,q}:
	 *
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.asserter)) {
        this.asserter = data().deepCopy(fields()[0].schema(), other.asserter);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder setAsserter(com.bbn.tc.schema.avro.cdm19.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder clearAsserter() {
      asserter = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder setSources(java.util.List<com.bbn.tc.schema.avro.cdm19.UUID> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder clearSources() {
      sources = null;
	 ...
	 * e.g.,
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder setProvenance(java.util.List<com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion> value) {
	 ...
	 * e.g.,
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.ProvenanceAssertion.Builder clearProvenance() {
      provenance = null;
    ...
    public ProvenanceAssertion build() {
      try {
        ...
        record.asserter = fieldSetFlags()[0] ? this.asserter : (com.bbn.tc.schema.avro.cdm19.UUID) defaultValue(fields()[0]);
