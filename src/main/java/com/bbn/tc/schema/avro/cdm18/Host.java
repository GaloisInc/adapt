...
public class Host extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.bbn.tc.schema.avro.cdm18.HostIdentifier> hostIdentifiers;
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm18.HostType hostType;
  /** names and addresses of network interfaces */
  @Deprecated public java.util.List<com.bbn.tc.schema.avro.cdm18.Interface> interfaces;
   ...
   */
  public Host(com.bbn.tc.schema.avro.cdm18.UUID uuid, java.lang.CharSequence hostName, java.util.List<com.bbn.tc.schema.avro.cdm18.HostIdentifier> hostIdentifiers, java.lang.CharSequence osDetails, com.bbn.tc.schema.avro.cdm18.HostType hostType, java.util.List<com.bbn.tc.schema.avro.cdm18.Interface> interfaces) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: hostIdentifiers = (java.util.List<com.bbn.tc.schema.avro.cdm18.HostIdentifier>)value$; break;
    case 3: osDetails = (java.lang.CharSequence)value$; break;
    case 4: hostType = (com.bbn.tc.schema.avro.cdm18.HostType)value$; break;
    case 5: interfaces = (java.util.List<com.bbn.tc.schema.avro.cdm18.Interface>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.bbn.tc.schema.avro.cdm18.HostIdentifier> getHostIdentifiers() {
   ...
   * @param value the value to set.
   */
  public void setHostIdentifiers(java.util.List<com.bbn.tc.schema.avro.cdm18.HostIdentifier> value) {
   ...
   */
  public com.bbn.tc.schema.avro.cdm18.HostType getHostType() {
    return hostType;
  }
   ...
   * @param value the value to set.
   */
  public void setHostType(com.bbn.tc.schema.avro.cdm18.HostType value) {
    this.hostType = value;
  }
   ...
   */
  public java.util.List<com.bbn.tc.schema.avro.cdm18.Interface> getInterfaces() {
    return interfaces;
  }
   ...
   */
  public static com.bbn.tc.schema.avro.cdm18.Host.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm18.Host.Builder();
  }
   ...
   * @return A new Host RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.Host.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.Host.Builder other) {
    return new com.bbn.tc.schema.avro.cdm18.Host.Builder(other);
  }
   ...
   * @return A new Host RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.Host.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.Host other) {
    return new com.bbn.tc.schema.avro.cdm18.Host.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Host>
    ...
    /** list of identifiers, such as serial number, IMEI number */
    private java.util.List<com.bbn.tc.schema.avro.cdm18.HostIdentifier> hostIdentifiers;
    /** OS level details revealed by tools such as uname -a */
    private java.lang.CharSequence osDetails;
    /** host's role or device type, such as mobile, server, desktop */
    private com.bbn.tc.schema.avro.cdm18.HostType hostType;
    /** names and addresses of network interfaces */
    private java.util.List<com.bbn.tc.schema.avro.cdm18.Interface> interfaces;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.Host.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.Host other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder setUuid(com.bbn.tc.schema.avro.cdm18.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder setHostName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder clearHostName() {
      hostName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder setHostIdentifiers(java.util.List<com.bbn.tc.schema.avro.cdm18.HostIdentifier> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder setOsDetails(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder clearOsDetails() {
      osDetails = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder setHostType(com.bbn.tc.schema.avro.cdm18.HostType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder clearHostType() {
      hostType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder setInterfaces(java.util.List<com.bbn.tc.schema.avro.cdm18.Interface> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Host.Builder clearInterfaces() {
      interfaces = null;
    ...
    public Host build() {
      try {
        ...
        record.hostIdentifiers = fieldSetFlags()[2] ? this.hostIdentifiers : (java.util.List<com.bbn.tc.schema.avro.cdm18.HostIdentifier>) defaultValue(fields()[2]);
        record.osDetails = fieldSetFlags()[3] ? this.osDetails : (java.lang.CharSequence) defaultValue(fields()[3]);
        record.hostType = fieldSetFlags()[4] ? this.hostType : (com.bbn.tc.schema.avro.cdm18.HostType) defaultValue(fields()[4]);
        record.interfaces = fieldSetFlags()[5] ? this.interfaces : (java.util.List<com.bbn.tc.schema.avro.cdm18.Interface>) defaultValue(fields()[5]);
        return record;
      } catch (Exception e) {
