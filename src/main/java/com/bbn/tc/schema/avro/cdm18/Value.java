...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm18.ValueType type;
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm18.ValueDataType valueDataType;
  ...
  @Deprecated public java.util.List<com.bbn.tc.schema.avro.cdm18.TagRunLengthTuple> tag;
  /** A complex value might comprise other component values if needed (Optional) */
  @Deprecated public java.util.List<com.bbn.tc.schema.avro.cdm18.Value> components;
   ...
   */
  public Value(java.lang.Integer size, com.bbn.tc.schema.avro.cdm18.ValueType type, com.bbn.tc.schema.avro.cdm18.ValueDataType valueDataType, java.lang.Boolean isNull, java.lang.CharSequence name, java.lang.CharSequence runtimeDataType, java.nio.ByteBuffer valueBytes, java.util.List<com.bbn.tc.schema.avro.cdm18.ProvenanceAssertion> provenance, java.util.List<com.bbn.tc.schema.avro.cdm18.TagRunLengthTuple> tag, java.util.List<com.bbn.tc.schema.avro.cdm18.Value> components) {
    this.size = size;
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: type = (com.bbn.tc.schema.avro.cdm18.ValueType)value$; break;
    case 2: valueDataType = (com.bbn.tc.schema.avro.cdm18.ValueDataType)value$; break;
    ...
    case 7: provenance = (java.util.List<com.bbn.tc.schema.avro.cdm18.ProvenanceAssertion>)value$; break;
    case 8: tag = (java.util.List<com.bbn.tc.schema.avro.cdm18.TagRunLengthTuple>)value$; break;
    case 9: components = (java.util.List<com.bbn.tc.schema.avro.cdm18.Value>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.bbn.tc.schema.avro.cdm18.ValueType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(com.bbn.tc.schema.avro.cdm18.ValueType value) {
    this.type = value;
  }
   ...
   * @return The actual datatype of the value elements, e.g., int, double, byte, etc. (Optional)
         ...
         *  Complex composite objects comprising of primitive values use the COMPLEX type
   */
  public com.bbn.tc.schema.avro.cdm18.ValueDataType getValueDataType() {
   ...
   * @param value the value to set.
   */
  public void setValueDataType(com.bbn.tc.schema.avro.cdm18.ValueDataType value) {
   ...
   * @return * The value's tag expression describing its provenance (Optional)
         * Since value could be an array, the tag can use run length encoding if needed.
   */
  public java.util.List<com.bbn.tc.schema.avro.cdm18.TagRunLengthTuple> getTag() {
    return tag;
  }
   ...
   * @param value the value to set.
   */
  public void setTag(java.util.List<com.bbn.tc.schema.avro.cdm18.TagRunLengthTuple> value) {
    this.tag = value;
  }
   ...
   */
  public java.util.List<com.bbn.tc.schema.avro.cdm18.Value> getComponents() {
    return components;
  }
   ...
   * @param value the value to set.
   */
  public void setComponents(java.util.List<com.bbn.tc.schema.avro.cdm18.Value> value) {
   ...
   */
  public static com.bbn.tc.schema.avro.cdm18.Value.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm18.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.Value.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.Value.Builder other) {
    return new com.bbn.tc.schema.avro.cdm18.Value.Builder(other);
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.Value.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.Value other) {
    return new com.bbn.tc.schema.avro.cdm18.Value.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
    ...
    private int size;
    /** The type indicates whether it's a source, sink, or control value */
    private com.bbn.tc.schema.avro.cdm18.ValueType type;
    /** The actual datatype of the value elements, e.g., int, double, byte, etc. (Optional)
         *  Strings are treated as char[] so type=CHAR
         *  String[] is a COMPLEX value whose components are the string values (each modeled as a char[])
         *  Complex composite objects comprising of primitive values use the COMPLEX type */
    private com.bbn.tc.schema.avro.cdm18.ValueDataType valueDataType;
    /** Whether this value is null, needed to indicate null objects (default: false) */
    ...
    /** * The value's tag expression describing its provenance (Optional)
         * Since value could be an array, the tag can use run length encoding if needed. */
    private java.util.List<com.bbn.tc.schema.avro.cdm18.TagRunLengthTuple> tag;
    /** A complex value might comprise other component values if needed (Optional) */
    private java.util.List<com.bbn.tc.schema.avro.cdm18.Value> components;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.Value other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.size)) {
        this.size = data().deepCopy(fields()[0].schema(), other.size);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setSize(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearSize() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setType(com.bbn.tc.schema.avro.cdm18.ValueType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setValueDataType(com.bbn.tc.schema.avro.cdm18.ValueDataType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearValueDataType() {
      valueDataType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setIsNull(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearIsNull() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setRuntimeDataType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearRuntimeDataType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setValueBytes(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearValueBytes() {
      valueBytes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setProvenance(java.util.List<com.bbn.tc.schema.avro.cdm18.ProvenanceAssertion> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearProvenance() {
      provenance = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setTag(java.util.List<com.bbn.tc.schema.avro.cdm18.TagRunLengthTuple> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearTag() {
      tag = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder setComponents(java.util.List<com.bbn.tc.schema.avro.cdm18.Value> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Value.Builder clearComponents() {
      components = null;
    ...
    public Value build() {
      try {
        ...
        record.type = fieldSetFlags()[1] ? this.type : (com.bbn.tc.schema.avro.cdm18.ValueType) defaultValue(fields()[1]);
        record.valueDataType = fieldSetFlags()[2] ? this.valueDataType : (com.bbn.tc.schema.avro.cdm18.ValueDataType) defaultValue(fields()[2]);
        ...
        record.provenance = fieldSetFlags()[7] ? this.provenance : (java.util.List<com.bbn.tc.schema.avro.cdm18.ProvenanceAssertion>) defaultValue(fields()[7]);
        record.tag = fieldSetFlags()[8] ? this.tag : (java.util.List<com.bbn.tc.schema.avro.cdm18.TagRunLengthTuple>) defaultValue(fields()[8]);
        record.components = fieldSetFlags()[9] ? this.components : (java.util.List<com.bbn.tc.schema.avro.cdm18.Value>) defaultValue(fields()[9]);
        return record;
      } catch (Exception e) {
