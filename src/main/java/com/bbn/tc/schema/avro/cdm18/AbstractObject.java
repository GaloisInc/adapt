...
public class AbstractObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm18.SHORT permission;
   ...
   * @param hostId Host where object exists
   ...
   * @param properties * Arbitrary key, value pairs describing the entity.
         ...
         * will become first-class attributes in the next CDM version.
   */
  public AbstractObject(com.bbn.tc.schema.avro.cdm18.UUID hostId, com.bbn.tc.schema.avro.cdm18.SHORT permission, java.lang.Integer epoch, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> properties) {
    this.hostId = hostId;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: hostId = (com.bbn.tc.schema.avro.cdm18.UUID)value$; break;
    case 1: permission = (com.bbn.tc.schema.avro.cdm18.SHORT)value$; break;
   ...
   * @return Host where object exists
   */
   ...
   */
  public com.bbn.tc.schema.avro.cdm18.SHORT getPermission() {
    return permission;
  }
   ...
   * @param value the value to set.
   */
  public void setPermission(com.bbn.tc.schema.avro.cdm18.SHORT value) {
   ...
   */
  public static com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder();
  }
   ...
   * @return A new AbstractObject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder other) {
    return new com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder(other);
  }
   ...
   * @return A new AbstractObject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.AbstractObject other) {
    return new com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AbstractObject>
    ...
    /** Permission bits defined over the object (Optional) */
    private com.bbn.tc.schema.avro.cdm18.SHORT permission;
    /** * Used to track when an object is deleted and a new one is
         * created with the same identifier. This is useful for when
         * UUIDs are based on something not likely to be unique, such
         * as file path. */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.hostId)) {
        this.hostId = data().deepCopy(fields()[0].schema(), other.hostId);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.AbstractObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.hostId)) {
        this.hostId = data().deepCopy(fields()[0].schema(), other.hostId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder setHostId(com.bbn.tc.schema.avro.cdm18.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder setPermission(com.bbn.tc.schema.avro.cdm18.SHORT value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder clearPermission() {
      permission = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder setEpoch(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder clearEpoch() {
      epoch = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder setProperties(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder clearProperties() {
      properties = null;
    ...
    public AbstractObject build() {
      try {
        ...
        record.hostId = fieldSetFlags()[0] ? this.hostId : (com.bbn.tc.schema.avro.cdm18.UUID) defaultValue(fields()[0]);
        record.permission = fieldSetFlags()[1] ? this.permission : (com.bbn.tc.schema.avro.cdm18.SHORT) defaultValue(fields()[1]);
