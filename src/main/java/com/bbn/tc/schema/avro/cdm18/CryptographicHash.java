...
public class CryptographicHash extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4791368001946303975L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CryptographicHash\",\"namespace\":\"com.bbn.tc.schema.avro.cdm18\",\"doc\":\"* Cryptographic hash records represent one or more cryptographic hashes for\\n     * an object, typically, a FileObject.\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"CryptoHashType\",\"doc\":\"Cryptographich hash types\",\"symbols\":[\"MD5\",\"SHA1\",\"SHA256\",\"SHA512\",\"AUTHENTIHASH\",\"SSDEEP\",\"IMPHASH\"]},\"doc\":\"The type of hash used\"},{\"name\":\"hash\",\"type\":\"string\",\"doc\":\"The base64 encoded hash value\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
  /** The type of hash used */
  @Deprecated public com.bbn.tc.schema.avro.cdm18.CryptoHashType type;
   ...
   */
  public CryptographicHash(com.bbn.tc.schema.avro.cdm18.CryptoHashType type, java.lang.CharSequence hash) {
    this.type = type;
    this.hash = hash;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (com.bbn.tc.schema.avro.cdm18.CryptoHashType)value$; break;
   ...
   */
  public com.bbn.tc.schema.avro.cdm18.CryptoHashType getType() {
    return type;
  }
   ...
   */
  public void setType(com.bbn.tc.schema.avro.cdm18.CryptoHashType value) {
    this.type = value;
  }
   ...
   */
  public static com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder();
  }
   ...
   * @return A new CryptographicHash RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder other) {
    return new com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder(other);
  }
   ...
   * @return A new CryptographicHash RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.CryptographicHash other) {
    return new com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CryptographicHash>
    ...
    /** The type of hash used */
    private com.bbn.tc.schema.avro.cdm18.CryptoHashType type;
    /** The base64 encoded hash value */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.CryptographicHash other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder setType(com.bbn.tc.schema.avro.cdm18.CryptoHashType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder setHash(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.CryptographicHash.Builder clearHash() {
      hash = null;
    ...
    public CryptographicHash build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (com.bbn.tc.schema.avro.cdm18.CryptoHashType) defaultValue(fields()[0]);
