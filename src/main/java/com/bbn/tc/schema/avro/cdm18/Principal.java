...
public class Principal extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm18.PrincipalType type;
   ...
   * @param hostId Host where principal exists
   ...
   * @param properties * Arbitrary key, value pairs describing the entity.
         ...
         * will become first-class attributes in the next CDM version.
   */
  public Principal(com.bbn.tc.schema.avro.cdm18.UUID uuid, com.bbn.tc.schema.avro.cdm18.PrincipalType type, com.bbn.tc.schema.avro.cdm18.UUID hostId, java.lang.CharSequence userId, java.lang.CharSequence username, java.util.List<java.lang.CharSequence> groupIds, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> properties) {
    this.uuid = uuid;
    this.type = type;
    this.hostId = hostId;
    this.userId = userId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: type = (com.bbn.tc.schema.avro.cdm18.PrincipalType)value$; break;
    ...
    case 5: groupIds = (java.util.List<java.lang.CharSequence>)value$; break;
   ...
   */
  public com.bbn.tc.schema.avro.cdm18.PrincipalType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(com.bbn.tc.schema.avro.cdm18.PrincipalType value) {
    this.type = value;
  }

  /**
   * Gets the value of the 'hostId' field.
   * @return Host where principal exists
   */
   ...
   */
  public static com.bbn.tc.schema.avro.cdm18.Principal.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm18.Principal.Builder();
  }
   ...
   * @return A new Principal RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.Principal.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.Principal.Builder other) {
    return new com.bbn.tc.schema.avro.cdm18.Principal.Builder(other);
  }
   ...
   * @return A new Principal RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.Principal.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.Principal other) {
    return new com.bbn.tc.schema.avro.cdm18.Principal.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Principal>
    ...
    /** The type of the principal, local by default */
    private com.bbn.tc.schema.avro.cdm18.PrincipalType type;
    /** Host where principal exists */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.Principal.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[5], other.groupIds)) {
        this.groupIds = data().deepCopy(fields()[5].schema(), other.groupIds);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.Principal other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder setUuid(com.bbn.tc.schema.avro.cdm18.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder setType(com.bbn.tc.schema.avro.cdm18.PrincipalType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder setHostId(com.bbn.tc.schema.avro.cdm18.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder setGroupIds(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder clearGroupIds() {
      groupIds = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder setProperties(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.Principal.Builder clearProperties() {
      properties = null;
    ...
    public Principal build() {
      try {
        ...
        record.type = fieldSetFlags()[1] ? this.type : (com.bbn.tc.schema.avro.cdm18.PrincipalType) defaultValue(fields()[1]);
        ...
        record.groupIds = fieldSetFlags()[5] ? this.groupIds : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[5]);
