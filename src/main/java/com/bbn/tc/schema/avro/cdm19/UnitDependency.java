...
public class UnitDependency extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public UnitDependency(com.bbn.tc.schema.avro.cdm19.UUID unit, com.bbn.tc.schema.avro.cdm19.UUID dependentUnit) {
    this.unit = unit;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: unit = (com.bbn.tc.schema.avro.cdm19.UUID)value$; break;
    case 1: dependentUnit = (com.bbn.tc.schema.avro.cdm19.UUID)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.bbn.tc.schema.avro.cdm19.UUID getUnit() {
    return unit;
  }
   ...
   */
  public void setUnit(com.bbn.tc.schema.avro.cdm19.UUID value) {
    this.unit = value;
  }
   ...
   */
  public com.bbn.tc.schema.avro.cdm19.UUID getDependentUnit() {
   ...
   * @param value the value to set.
   */
  public void setDependentUnit(com.bbn.tc.schema.avro.cdm19.UUID value) {
   ...
   */
  public static com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder();
  }
   ...
   * @return A new UnitDependency RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder other) {
    return new com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder(other);
  }
   ...
   * @return A new UnitDependency RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.UnitDependency other) {
    return new com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UnitDependency>
    ...
    private com.bbn.tc.schema.avro.cdm19.UUID unit;
    private com.bbn.tc.schema.avro.cdm19.UUID dependentUnit;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.UnitDependency other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.unit)) {
        this.unit = data().deepCopy(fields()[0].schema(), other.unit);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder setUnit(com.bbn.tc.schema.avro.cdm19.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder clearUnit() {
      unit = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder setDependentUnit(com.bbn.tc.schema.avro.cdm19.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.UnitDependency.Builder clearDependentUnit() {
      dependentUnit = null;
