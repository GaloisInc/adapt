...
public class TheiaQueryResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 893326309788201918L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TheiaQueryResult\",\"namespace\":\"com.bbn.tc.schema.avro\",\"doc\":\"* TheiaQueryResult used to indicate that the fine-grained analysis created\\n     * by a query has finished\",\"fields\":[{\"name\":\"queryId\",\"type\":{\"type\":\"fixed\",\"name\":\"UUID\",\"size\":16}},{\"name\":\"tagIds\",\"type\":{\"type\":\"array\",\"items\":\"UUID\"}}]}");
   ...
   */
  public TheiaQueryResult(com.bbn.tc.schema.avro.UUID queryId, java.util.List<com.bbn.tc.schema.avro.UUID> tagIds) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: tagIds = (java.util.List<com.bbn.tc.schema.avro.UUID>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static com.bbn.tc.schema.avro.TheiaQueryResult.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.TheiaQueryResult.Builder();
  }
   ...
   * @return A new TheiaQueryResult RecordBuilder
   */
  public static com.bbn.tc.schema.avro.TheiaQueryResult.Builder newBuilder(com.bbn.tc.schema.avro.TheiaQueryResult.Builder other) {
    return new com.bbn.tc.schema.avro.TheiaQueryResult.Builder(other);
  }
   ...
   * @return A new TheiaQueryResult RecordBuilder
   */
  public static com.bbn.tc.schema.avro.TheiaQueryResult.Builder newBuilder(com.bbn.tc.schema.avro.TheiaQueryResult other) {
    return new com.bbn.tc.schema.avro.TheiaQueryResult.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TheiaQueryResult>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.TheiaQueryResult.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.TheiaQueryResult other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.queryId)) {
        this.queryId = data().deepCopy(fields()[0].schema(), other.queryId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.TheiaQueryResult.Builder setQueryId(com.bbn.tc.schema.avro.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.TheiaQueryResult.Builder clearQueryId() {
      queryId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.TheiaQueryResult.Builder setTagIds(java.util.List<com.bbn.tc.schema.avro.UUID> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.TheiaQueryResult.Builder clearTagIds() {
      tagIds = null;
    ...
    public TheiaQueryResult build() {
      try {
        ...
        record.tagIds = fieldSetFlags()[1] ? this.tagIds : (java.util.List<com.bbn.tc.schema.avro.UUID>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
