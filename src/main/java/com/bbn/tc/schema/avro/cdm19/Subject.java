...
public class Subject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** the subject type */
  @Deprecated public com.bbn.tc.schema.avro.cdm19.SubjectType type;
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm19.UUID parentSubject;
  /** * UUID of local principal that owns this subject This
         * attribute is optional because there are times when
         * the owner of the subject may not be known at the time the file
         * object is reported (e.g., missed open call). Otherwise,
         * the local principal SHOULD be included. */
  @Deprecated public com.bbn.tc.schema.avro.cdm19.UUID localPrincipal;
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm19.PrivilegeLevel privilegeLevel;
   ...
   * @param properties * Arbitrary key, value pairs describing the entity.
         ...
         * will become first-class attributes in the next CDM version.
   */
  public Subject(com.bbn.tc.schema.avro.cdm19.UUID uuid, com.bbn.tc.schema.avro.cdm19.SubjectType type, java.lang.Integer cid, com.bbn.tc.schema.avro.cdm19.UUID parentSubject, com.bbn.tc.schema.avro.cdm19.UUID localPrincipal, java.lang.Long startTimestampNanos, java.lang.Integer unitId, java.lang.Integer iteration, java.lang.Integer count, java.lang.CharSequence cmdLine, com.bbn.tc.schema.avro.cdm19.PrivilegeLevel privilegeLevel, java.util.List<java.lang.CharSequence> importedLibraries, java.util.List<java.lang.CharSequence> exportedLibraries, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> properties) {
    this.uuid = uuid;
    this.type = type;
    this.cid = cid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: type = (com.bbn.tc.schema.avro.cdm19.SubjectType)value$; break;
    case 2: cid = (java.lang.Integer)value$; break;
    case 3: parentSubject = (com.bbn.tc.schema.avro.cdm19.UUID)value$; break;
    case 4: localPrincipal = (com.bbn.tc.schema.avro.cdm19.UUID)value$; break;
    ...
    case 10: privilegeLevel = (com.bbn.tc.schema.avro.cdm19.PrivilegeLevel)value$; break;
   ...
   */
  public com.bbn.tc.schema.avro.cdm19.SubjectType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(com.bbn.tc.schema.avro.cdm19.SubjectType value) {
    this.type = value;
  }
   ...
   * @return * parent subject's UUID. For a process, this is a parent
         ...
         * be known; null value indicates that the parent is unknown.
   */
  public com.bbn.tc.schema.avro.cdm19.UUID getParentSubject() {
   ...
   * @param value the value to set.
   */
  public void setParentSubject(com.bbn.tc.schema.avro.cdm19.UUID value) {
   ...
   * @return * UUID of local principal that owns this subject This
         ...
         * the local principal SHOULD be included.
   */
  public com.bbn.tc.schema.avro.cdm19.UUID getLocalPrincipal() {
   ...
   * @param value the value to set.
   */
  public void setLocalPrincipal(com.bbn.tc.schema.avro.cdm19.UUID value) {
   ...
   */
  public com.bbn.tc.schema.avro.cdm19.PrivilegeLevel getPrivilegeLevel() {
   ...
   * @param value the value to set.
   */
  public void setPrivilegeLevel(com.bbn.tc.schema.avro.cdm19.PrivilegeLevel value) {
   ...
   */
  public static com.bbn.tc.schema.avro.cdm19.Subject.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm19.Subject.Builder();
  }
   ...
   * @return A new Subject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.Subject.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.Subject.Builder other) {
    return new com.bbn.tc.schema.avro.cdm19.Subject.Builder(other);
  }
   ...
   * @return A new Subject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.Subject.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.Subject other) {
    return new com.bbn.tc.schema.avro.cdm19.Subject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Subject>
    ...
    /** the subject type */
    private com.bbn.tc.schema.avro.cdm19.SubjectType type;
    /** Context ID: OS process id for type process, thread id for threads */
    private int cid;
    /** * parent subject's UUID. For a process, this is a parent
         * process. For a thread, this is the process that created the
         * thread. Only optional because in some cases the parent may not
         * be known; null value indicates that the parent is unknown. */
    private com.bbn.tc.schema.avro.cdm19.UUID parentSubject;
    /** * UUID of local principal that owns this subject This
         * attribute is optional because there are times when
         * the owner of the subject may not be known at the time the file
         * object is reported (e.g., missed open call). Otherwise,
         * the local principal SHOULD be included. */
    private com.bbn.tc.schema.avro.cdm19.UUID localPrincipal;
    /** * The start time of the subject
         * A timestamp stores the number of nanoseconds from the unix epoch, 1 January 1970 00:00:00.000000 UTC.
         *
         * This attribute is optional because there are times when the
    ...
    /** Windows allows processes to have different privilege levels (Optional) */
    private com.bbn.tc.schema.avro.cdm19.PrivilegeLevel privilegeLevel;
    /** * imported libraries. (Optional). Lists the libraries that
         * are expected to be loaded, but may not necessarily
         * correspond 1-to-1 with actual load library events because
         * some libraries may already be loaded when this event
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.Subject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.Subject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setUuid(com.bbn.tc.schema.avro.cdm19.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setType(com.bbn.tc.schema.avro.cdm19.SubjectType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setCid(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearCid() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setParentSubject(com.bbn.tc.schema.avro.cdm19.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearParentSubject() {
      parentSubject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setLocalPrincipal(com.bbn.tc.schema.avro.cdm19.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearLocalPrincipal() {
      localPrincipal = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setStartTimestampNanos(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearStartTimestampNanos() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setUnitId(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearUnitId() {
      unitId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setIteration(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearIteration() {
      iteration = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setCount(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearCount() {
      count = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setCmdLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearCmdLine() {
      cmdLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setPrivilegeLevel(com.bbn.tc.schema.avro.cdm19.PrivilegeLevel value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearPrivilegeLevel() {
      privilegeLevel = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setImportedLibraries(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearImportedLibraries() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setExportedLibraries(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearExportedLibraries() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder setProperties(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.Subject.Builder clearProperties() {
      properties = null;
    ...
    public Subject build() {
      try {
        ...
        record.type = fieldSetFlags()[1] ? this.type : (com.bbn.tc.schema.avro.cdm19.SubjectType) defaultValue(fields()[1]);
        record.cid = fieldSetFlags()[2] ? this.cid : (java.lang.Integer) defaultValue(fields()[2]);
        record.parentSubject = fieldSetFlags()[3] ? this.parentSubject : (com.bbn.tc.schema.avro.cdm19.UUID) defaultValue(fields()[3]);
        record.localPrincipal = fieldSetFlags()[4] ? this.localPrincipal : (com.bbn.tc.schema.avro.cdm19.UUID) defaultValue(fields()[4]);
        ...
        record.privilegeLevel = fieldSetFlags()[10] ? this.privilegeLevel : (com.bbn.tc.schema.avro.cdm19.PrivilegeLevel) defaultValue(fields()[10]);
