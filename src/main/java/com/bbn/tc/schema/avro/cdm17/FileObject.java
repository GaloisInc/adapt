...
public class FileObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6038972941294633589L;
  ...
  @Deprecated public com.bbn.tc.schema.avro.FileObjectType type;
   ...
   */
  public FileObject(com.bbn.tc.schema.avro.UUID uuid, com.bbn.tc.schema.avro.AbstractObject baseObject, com.bbn.tc.schema.avro.FileObjectType type, java.lang.Integer fileDescriptor, com.bbn.tc.schema.avro.UUID localPrincipal, java.lang.Long size, java.lang.CharSequence peInfo, java.util.List<com.bbn.tc.schema.avro.CryptographicHash> hashes) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: type = (com.bbn.tc.schema.avro.FileObjectType)value$; break;
    ...
    case 7: hashes = (java.util.List<com.bbn.tc.schema.avro.CryptographicHash>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.bbn.tc.schema.avro.FileObjectType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(com.bbn.tc.schema.avro.FileObjectType value) {
    this.type = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FileObject>
    ...
    /** The type of FileObject */
    private com.bbn.tc.schema.avro.FileObjectType type;
    /** The file descriptor (Optional) */
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.FileObject.Builder setType(com.bbn.tc.schema.avro.FileObjectType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.FileObject.Builder clearType() {
      type = null;
    ...
    public FileObject build() {
      try {
        ...
        record.type = fieldSetFlags()[2] ? this.type : (com.bbn.tc.schema.avro.FileObjectType) defaultValue(fields()[2]);
        ...
        record.hashes = fieldSetFlags()[7] ? this.hashes : (java.util.List<com.bbn.tc.schema.avro.CryptographicHash>) defaultValue(fields()[7]);
        return record;
      } catch (Exception e) {
