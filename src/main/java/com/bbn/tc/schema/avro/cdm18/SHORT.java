...
public class SHORT extends org.apache.avro.specific.SpecificFixed {
  private static final long serialVersionUID = 3288016060853356355L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"fixed\",\"name\":\"SHORT\",\"namespace\":\"com.bbn.tc.schema.avro.cdm18\",\"size\":2}");
