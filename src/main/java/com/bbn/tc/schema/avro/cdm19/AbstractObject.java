...
public class AbstractObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @param properties * Arbitrary key, value pairs describing the entity.
         ...
         * will become first-class attributes in the next CDM version.
   */
  public AbstractObject(com.bbn.tc.schema.avro.cdm19.SHORT permission, java.lang.Integer epoch, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> properties) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: permission = (com.bbn.tc.schema.avro.cdm19.SHORT)value$; break;
   ...
   */
  public com.bbn.tc.schema.avro.cdm19.SHORT getPermission() {
    return permission;
  }
   ...
   */
  public void setPermission(com.bbn.tc.schema.avro.cdm19.SHORT value) {
   ...
   */
  public static com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder();
  }
   ...
   * @return A new AbstractObject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder other) {
    return new com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder(other);
  }
   ...
   * @return A new AbstractObject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.AbstractObject other) {
    return new com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AbstractObject>
    ...
    /** Permission bits defined over the object (Optional) */
    private com.bbn.tc.schema.avro.cdm19.SHORT permission;
    /** * Used to track when an object is deleted and a new one is
         * created with the same identifier. This is useful for when
         * UUIDs are based on something not likely to be unique, such
         * as file path. */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.AbstractObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.permission)) {
        this.permission = data().deepCopy(fields()[0].schema(), other.permission);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder setPermission(com.bbn.tc.schema.avro.cdm19.SHORT value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder clearPermission() {
      permission = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder setEpoch(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder clearEpoch() {
      epoch = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder setProperties(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder clearProperties() {
      properties = null;
    ...
    public AbstractObject build() {
      try {
        ...
        record.permission = fieldSetFlags()[0] ? this.permission : (com.bbn.tc.schema.avro.cdm19.SHORT) defaultValue(fields()[0]);
