...
public class SrcSinkObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm18.SrcSinkType type;
   ...
   */
  public SrcSinkObject(com.bbn.tc.schema.avro.cdm18.UUID uuid, com.bbn.tc.schema.avro.cdm18.AbstractObject baseObject, com.bbn.tc.schema.avro.cdm18.SrcSinkType type, java.lang.Integer fileDescriptor) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: type = (com.bbn.tc.schema.avro.cdm18.SrcSinkType)value$; break;
   ...
   */
  public com.bbn.tc.schema.avro.cdm18.SrcSinkType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(com.bbn.tc.schema.avro.cdm18.SrcSinkType value) {
    this.type = value;
  }
   ...
   */
  public static com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder();
  }
   ...
   * @return A new SrcSinkObject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder other) {
    return new com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder(other);
  }
   ...
   * @return A new SrcSinkObject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder newBuilder(com.bbn.tc.schema.avro.cdm18.SrcSinkObject other) {
    return new com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SrcSinkObject>
    ...
    /** The type of the object */
    private com.bbn.tc.schema.avro.cdm18.SrcSinkType type;
    /** The file descriptor (Optional) */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm18.SrcSinkObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder setUuid(com.bbn.tc.schema.avro.cdm18.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder setBaseObject(com.bbn.tc.schema.avro.cdm18.AbstractObject value) {
     ...
     * @return This builder.
     */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder setBaseObjectBuilder(com.bbn.tc.schema.avro.cdm18.AbstractObject.Builder value) {
      clearBaseObject();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder clearBaseObject() {
      baseObject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder setType(com.bbn.tc.schema.avro.cdm18.SrcSinkType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder setFileDescriptor(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm18.SrcSinkObject.Builder clearFileDescriptor() {
      fileDescriptor = null;
    ...
    public SrcSinkObject build() {
      try {
        ...
        record.type = fieldSetFlags()[2] ? this.type : (com.bbn.tc.schema.avro.cdm18.SrcSinkType) defaultValue(fields()[2]);
