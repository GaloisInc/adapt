...
public class RegistryKeyObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.bbn.tc.schema.avro.cdm19.Value value;
   ...
   */
  public RegistryKeyObject(com.bbn.tc.schema.avro.cdm19.UUID uuid, com.bbn.tc.schema.avro.cdm19.AbstractObject baseObject, java.lang.CharSequence key, com.bbn.tc.schema.avro.cdm19.Value value, java.lang.Long size) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: value = (com.bbn.tc.schema.avro.cdm19.Value)value$; break;
   ...
   */
  public com.bbn.tc.schema.avro.cdm19.Value getValue() {
    return value;
  }
   ...
   * @param value the value to set.
   */
  public void setValue(com.bbn.tc.schema.avro.cdm19.Value value) {
    this.value = value;
  }
   ...
   */
  public static com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder();
  }
   ...
   * @return A new RegistryKeyObject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder other) {
    return new com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder(other);
  }
   ...
   * @return A new RegistryKeyObject RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder newBuilder(com.bbn.tc.schema.avro.cdm19.RegistryKeyObject other) {
    return new com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RegistryKeyObject>
    ...
    /** The value of the key */
    private com.bbn.tc.schema.avro.cdm19.Value value;
    private com.bbn.tc.schema.avro.cdm19.Value.Builder valueBuilder;
    /** The entry size in bytes (Optional) */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder other) {
      super(other);
      ...
      if (other.hasValueBuilder()) {
        this.valueBuilder = com.bbn.tc.schema.avro.cdm19.Value.newBuilder(other.getValueBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm19.RegistryKeyObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder setUuid(com.bbn.tc.schema.avro.cdm19.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder setBaseObject(com.bbn.tc.schema.avro.cdm19.AbstractObject value) {
     ...
     * @return This builder.
     */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder setBaseObjectBuilder(com.bbn.tc.schema.avro.cdm19.AbstractObject.Builder value) {
      clearBaseObject();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder clearBaseObject() {
      baseObject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder setKey(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder clearKey() {
      key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder setValue(com.bbn.tc.schema.avro.cdm19.Value value) {
     ...
     * @return This builder.
     */
    public com.bbn.tc.schema.avro.cdm19.Value.Builder getValueBuilder() {
      if (valueBuilder == null) {
        if (hasValue()) {
          setValueBuilder(com.bbn.tc.schema.avro.cdm19.Value.newBuilder(value));
        } else {
          setValueBuilder(com.bbn.tc.schema.avro.cdm19.Value.newBuilder());
        }
      }
      return valueBuilder;
    }
     ...
     * @return This builder.
     */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder setValueBuilder(com.bbn.tc.schema.avro.cdm19.Value.Builder value) {
      clearValue();
      valueBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder clearValue() {
      value = null;
      valueBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder setSize(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm19.RegistryKeyObject.Builder clearSize() {
      size = null;
    ...
    public RegistryKeyObject build() {
      try {
        ...
        if (valueBuilder != null) {
          ...
          record.value = fieldSetFlags()[3] ? this.value : (com.bbn.tc.schema.avro.cdm19.Value) defaultValue(fields()[3]);
        }
