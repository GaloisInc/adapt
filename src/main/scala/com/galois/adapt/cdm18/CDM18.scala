...
case object EventType extends CustomEnum[EventType] { val values = Seq(EVENT_ACCEPT, EVENT_ADD_OBJECT_ATTRIBUTE, EVENT_BIND, EVENT_BLIND, EVENT_BOOT, EVENT_CHANGE_PRINCIPAL, EVENT_CHECK_FILE_ATTRIBUTES, EVENT_CLONE, EVENT_CLOSE, EVENT_CONNECT, EVENT_CREATE_OBJECT, EVENT_CREATE_THREAD, EVENT_DUP, EVENT_EXECUTE, EVENT_EXIT, EVENT_FLOWS_TO, EVENT_FNCTL, EVENT_FORK, EVENT_LINK, EVENT_LOADLIBRARY, EVENT_LOGCLEAR, EVENT_LOGIN, EVENT_LOGOUT, EVENT_LSEEK, EVENT_MMAP, EVENT_MODIFY_FILE_ATTRIBUTES, EVENT_MODIFY_PROCESS, EVENT_MOUNT, EVENT_MPROTECT, EVENT_OPEN, EVENT_OTHER, EVENT_READ, EVENT_READ_SOCKET_PARAMS, EVENT_RECVFROM, EVENT_RECVMSG, EVENT_RENAME, EVENT_SENDTO, EVENT_SENDMSG, EVENT_SERVICEINSTALL, EVENT_SHM, EVENT_SIGNAL, EVENT_STARTSERVICE, EVENT_TRUNCATE, EVENT_UMOUNT, EVENT_UNIT, EVENT_UNLINK, EVENT_UPDATE, EVENT_WAIT, EVENT_WRITE, EVENT_WRITE_SOCKET_PARAMS) }
