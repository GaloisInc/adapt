...
import com.galois.adapt.cdm18.{CDM18, EVENT_CHECK_FILE_ATTRIBUTES, EVENT_CLOSE, EVENT_CREATE_OBJECT, EVENT_DUP, EVENT_EXECUTE, EVENT_FCNTL, EVENT_LINK, EVENT_LOADLIBRARY, EVENT_LSEEK, EVENT_MMAP, EVENT_MODIFY_FILE_ATTRIBUTES, EVENT_OPEN, EVENT_READ, EVENT_RECVFROM, EVENT_RECVMSG, EVENT_RENAME, EVENT_SENDMSG, EVENT_SENDTO, EVENT_TRUNCATE, EVENT_UNLINK, EVENT_UPDATE, EVENT_WRITE, Event, FileObject}
...
//      .merge(commandSource)
      .statefulMapConcat[(FileUUID, MutableSet[Event])]{ () =>
//        var processUuidOpt: Option[ProcessUUID] = None
        var fileUuidOpt: Option[FileUUID] = None
        val fileEvents = MutableSet.empty[Event]
...
//            fileEvents.toList
  ...
  val fileEventTypes = List(EVENT_CHECK_FILE_ATTRIBUTES, EVENT_CLOSE, EVENT_CREATE_OBJECT, EVENT_DUP, EVENT_EXECUTE, EVENT_FCNTL, EVENT_LINK, EVENT_LSEEK, EVENT_MMAP, EVENT_MODIFY_FILE_ATTRIBUTES, EVENT_OPEN, EVENT_READ, EVENT_RENAME, EVENT_TRUNCATE, EVENT_UNLINK, EVENT_UPDATE, EVENT_WRITE)
