...
trait CustomEnum[T] extends CDM20 {
  val values: Seq[T]
...
// Updated
sealed trait SubjectType extends CDM20
case object SubjectType extends CustomEnum[SubjectType] { val values = Seq(SUBJECT_PROCESS, SUBJECT_THREAD, SUBJECT_UNIT, SUBJECT_BASIC_BLOCK, SUBJECT_OTHER) }
...
case object SUBJECT_OTHER extends SubjectType

// No changes
sealed trait PrivilegeLevel extends CDM20
...
// No changes
sealed trait SrcSinkType extends CDM20
...
// Updated
sealed trait InstrumentationSource extends CDM20
case object InstrumentationSource extends CustomEnum[InstrumentationSource] { val values =
Seq(SOURCE_ANDROID_JAVA_CLEARSCOPE, SOURCE_ANDROID_NATIVE_CLEARSCOPE, SOURCE_FREEBSD_OPENBSM_TRACE, SOURCE_FREEBSD_DTRACE_CADETS, SOURCE_FREEBSD_TESLA_CADETS, SOURCE_FREEBSD_LOOM_CADETS, SOURCE_FREEBSD_MACIF_CADETS, SOURCE_PVM_CADETS, SOURCE_LINUX_SYSCALL_TRACE, SOURCE_LINUX_NETFILTER_TRACE, SOURCE_LINUX_PROC_TRACE, SOURCE_LINUX_BEEP_TRACE, SOURCE_LINUX_THEIA, SOURCE_WINDOWS_DIFT_FAROS, SOURCE_WINDOWS_PSA_FAROS, SOURCE_WINDOWS_FIVEDIRECTIONS, SOURCE_WINDOWS_MARPLE) }
...
case object SOURCE_PVM_CADETS extends InstrumentationSource
...
// No changes
sealed trait PrincipalType extends CDM20
...
// Updated
sealed trait EventType extends CDM20
case object EventType extends CustomEnum[EventType] { val values = Seq(EVENT_ACCEPT, EVENT_ADD_OBJECT_ATTRIBUTE, EVENT_BIND, EVENT_BLIND, EVENT_BOOT, EVENT_CHANGE_PRINCIPAL, EVENT_CHECK_FILE_ATTRIBUTES, EVENT_CLONE, EVENT_CLOSE, EVENT_CONNECT, EVENT_CORRELATION, EVENT_CREATE_OBJECT, EVENT_CREATE_THREAD, EVENT_DUP, EVENT_EXECUTE, EVENT_EXIT, EVENT_FLOWS_TO, EVENT_FCNTL, EVENT_FORK, EVENT_LINK, EVENT_LOADLIBRARY, EVENT_LOGCLEAR, EVENT_LOGIN, EVENT_LOGOUT, EVENT_LSEEK, EVENT_MMAP, EVENT_MODIFY_FILE_ATTRIBUTES, EVENT_MODIFY_PROCESS, EVENT_MOUNT, EVENT_MPROTECT, EVENT_OPEN, EVENT_OTHER, EVENT_READ, EVENT_READ_SOCKET_PARAMS, EVENT_RECVFROM, EVENT_RECVMSG, EVENT_RENAME, EVENT_SENDTO, EVENT_SENDMSG, EVENT_SERVICEINSTALL, EVENT_SHM, EVENT_SIGNAL, EVENT_STARTSERVICE, EVENT_TRUNCATE, EVENT_UMOUNT, EVENT_UNIT, EVENT_UNLINK, EVENT_UPDATE, EVENT_WAIT, EVENT_WRITE, EVENT_WRITE_SOCKET_PARAMS, EVENT_TEE, EVENT_SPLICE, EVENT_VMSPLICE, EVENT_INIT_MODULE, EVENT_FINIT_MODULE, PSEUDO_EVENT_PARENT_SUBJECT) }
...
case object EVENT_CORRELATION extends EventType
...
case object EVENT_TEE extends EventType
case object EVENT_SPLICE extends EventType
case object EVENT_VMSPLICE extends EventType
case object EVENT_INIT_MODULE extends EventType
case object EVENT_FINIT_MODULE extends EventType
case object PSEUDO_EVENT_PARENT_SUBJECT extends EventType   // Added by us to pluck out parent/child processes

// No change 
sealed trait FileObjectType extends CDM20
...
// No change 
sealed trait IpcObjectType extends CDM20
...
case object IPC_OBJECT_SOCKET_PAIR extends IpcObjectType
case object IPC_OBJECT_SOCKET_PATHNAME extends IpcObjectType
...
// No change
sealed trait ValueType extends CDM20
...
// No change 
sealed trait ValueDataType extends CDM20
...
// No change
sealed trait TagOpCode extends CDM20
...
// No change
sealed trait IntegrityTag extends CDM20
...
// No change
sealed trait ConfidentialityTag extends CDM20
...
// No change
sealed trait CryptoHashType extends CDM20
...
// Updated
sealed trait HostType extends CDM20
case object HostType extends CustomEnum[HostType] { val values = Seq(HOST_MOBILE, HOST_SERVER, HOST_DESKTOP, HOST_OTHER) }
...
case object HOST_OTHER extends HostType
