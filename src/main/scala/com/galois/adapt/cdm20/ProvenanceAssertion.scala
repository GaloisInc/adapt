...
case object ProvenanceAssertion extends CDM20Constructor[ProvenanceAssertion] {
  type RawCDMType = cdm20.ProvenanceAssertion

  def from(cdm: RawCDM20Type): Try[ProvenanceAssertion] = Try {
    ProvenanceAssertion(
      cdm.getAsserter,
