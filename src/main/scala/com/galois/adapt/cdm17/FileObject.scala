...
) extends FreeDomainNode[FileObject] with CDM17 with DBWritable with DBNodeable[CDM17.EdgeTypes.EdgeTypes] {
...
case object FileObject extends FreeNodeConstructor with CDM17Constructor[FileObject] {
