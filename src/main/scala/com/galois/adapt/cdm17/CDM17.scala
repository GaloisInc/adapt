...
trait CustomEnum[T] extends CDM17 {
  val values: Seq[T]
  def from(s: String): Option[T] = values.find(_.toString == s)  // TODO: strings will be slow. Use ordinals.
}

case class FixedShort(bytes: Array[Byte]) // extends AnyVal

sealed trait SubjectType extends CDM17
...
sealed trait PrivilegeLevel extends CDM17
...
sealed trait SrcSinkType extends CDM17
...
sealed trait InstrumentationSource extends CDM17
...
sealed trait PrincipalType extends CDM17
...
sealed trait EventType extends CDM17
...
sealed trait FileObjectType extends CDM17
...
sealed trait ValueType extends CDM17
...
sealed trait ValueDataType extends CDM17
...
sealed trait TagOpCode extends CDM17
...
sealed trait IntegrityTag extends CDM17
...
sealed trait ConfidentialityTag extends CDM17
