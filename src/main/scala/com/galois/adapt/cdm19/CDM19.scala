...
trait CustomEnum[T] extends CDM19 {
  val values: Seq[T]
...
// No changes
sealed trait SubjectType extends CDM19
...
// No changes
sealed trait PrivilegeLevel extends CDM19
...
// No changes
sealed trait SrcSinkType extends CDM19
...
// No changes
sealed trait PrincipalType extends CDM19
...
// Updated
sealed trait EventType extends CDM19
...
// Updated
sealed trait FileObjectType extends CDM19
...
case object IpcObjectType extends CustomEnum[IpcObjectType] { val values = Seq(IPC_OBJECT_PIPE_NAMED, IPC_OBJECT_PIPE_UNNAMED, IPC_OBJECT_SOCKET_ABSTRACT, IPC_OBJECT_SOCKET_PAIR, IPC_OBJECT_SOCKET_PATHNAME, IPC_OBJECT_WINDOWS_ALPC, IPC_OBJECT_WINDOWS_MAILSLOT) }
...
// Updated
sealed trait ValueDataType extends CDM19
...
// No change
sealed trait TagOpCode extends CDM19
...
// No change
sealed trait IntegrityTag extends CDM19
...
// No change
sealed trait ConfidentialityTag extends CDM19
...
// No change
sealed trait CryptoHashType extends CDM19
