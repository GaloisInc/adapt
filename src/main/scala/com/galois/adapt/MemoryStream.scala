...
//            memoryEvents.toList
  ...
  val memoryEventTypes = List(EVENT_CREATE_OBJECT, EVENT_DUP, EVENT_EXECUTE, EVENT_FCNTL, EVENT_LINK, EVENT_LSEEK, EVENT_MMAP, EVENT_MODIFY_FILE_ATTRIBUTES, EVENT_MPROTECT, EVENT_OPEN, EVENT_READ, EVENT_RENAME, EVENT_SHM, EVENT_TRUNCATE, EVENT_UNLINK, EVENT_UPDATE, EVENT_WRITE, EVENT_LOADLIBRARY)
