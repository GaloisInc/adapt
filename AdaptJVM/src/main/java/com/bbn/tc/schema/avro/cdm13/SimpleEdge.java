...
public class SimpleEdge extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public SimpleEdge(com.bbn.tc.schema.avro.cdm13.UUID fromUuid, com.bbn.tc.schema.avro.cdm13.UUID toUuid, com.bbn.tc.schema.avro.cdm13.EdgeType type, java.lang.Long timestamp, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> properties) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: fromUuid = (com.bbn.tc.schema.avro.cdm13.UUID)value$; break;
    case 1: toUuid = (com.bbn.tc.schema.avro.cdm13.UUID)value$; break;
    case 2: type = (com.bbn.tc.schema.avro.cdm13.EdgeType)value$; break;
   ...
   */
  public com.bbn.tc.schema.avro.cdm13.UUID getFromUuid() {
    return fromUuid;
  }
   ...
   */
  public void setFromUuid(com.bbn.tc.schema.avro.cdm13.UUID value) {
    this.fromUuid = value;
  }
   ...
   */
  public com.bbn.tc.schema.avro.cdm13.UUID getToUuid() {
    return toUuid;
  }
   ...
   * @param value the value to set.
   */
  public void setToUuid(com.bbn.tc.schema.avro.cdm13.UUID value) {
    this.toUuid = value;
  }
   ...
   */
  public com.bbn.tc.schema.avro.cdm13.EdgeType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(com.bbn.tc.schema.avro.cdm13.EdgeType value) {
    this.type = value;
  }
   ...
   */
  public static com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder();
  }
   ...
   * @return A new SimpleEdge RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder newBuilder(com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder other) {
    return new com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder(other);
  }
   ...
   * @return A new SimpleEdge RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder newBuilder(com.bbn.tc.schema.avro.cdm13.SimpleEdge other) {
    return new com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SimpleEdge>
    ...
    /** A unique id of the From entity on the edge */
    private com.bbn.tc.schema.avro.cdm13.UUID fromUuid;
    /** The id of the To entity on the edge */
    private com.bbn.tc.schema.avro.cdm13.UUID toUuid;
    /** The type of the edge, see EdgeType */
    private com.bbn.tc.schema.avro.cdm13.EdgeType type;
    /** * When the edge was created.
        * Timestamp stores the number of microseconds from the unix epoch, 1 January 1970 00:00:00.000000 UTC. */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm13.SimpleEdge other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.fromUuid)) {
        this.fromUuid = data().deepCopy(fields()[0].schema(), other.fromUuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder setFromUuid(com.bbn.tc.schema.avro.cdm13.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder clearFromUuid() {
      fromUuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder setToUuid(com.bbn.tc.schema.avro.cdm13.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder clearToUuid() {
      toUuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder setType(com.bbn.tc.schema.avro.cdm13.EdgeType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder setProperties(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.SimpleEdge.Builder clearProperties() {
      properties = null;
    ...
    public SimpleEdge build() {
      try {
        ...
        record.fromUuid = fieldSetFlags()[0] ? this.fromUuid : (com.bbn.tc.schema.avro.cdm13.UUID) defaultValue(fields()[0]);
        record.toUuid = fieldSetFlags()[1] ? this.toUuid : (com.bbn.tc.schema.avro.cdm13.UUID) defaultValue(fields()[1]);
        record.type = fieldSetFlags()[2] ? this.type : (com.bbn.tc.schema.avro.cdm13.EdgeType) defaultValue(fields()[2]);
