...
public class UnitDependency extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8411215209934784236L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UnitDependency\",\"namespace\":\"com.bbn.tc.schema.avro\",\"doc\":\"* This record captures a relationship edge between two units, one\\n     * dependent on the other. This relationship is inferred from a\\n     * combination of underlying events.\",\"fields\":[{\"name\":\"unit\",\"type\":{\"type\":\"fixed\",\"name\":\"UUID\",\"size\":16}},{\"name\":\"dependentUnit\",\"type\":\"UUID\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
  @Deprecated public com.bbn.tc.schema.avro.UUID unit;
  @Deprecated public com.bbn.tc.schema.avro.UUID dependentUnit;
   ...
   */
  public UnitDependency(com.bbn.tc.schema.avro.UUID unit, com.bbn.tc.schema.avro.UUID dependentUnit) {
    this.unit = unit;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: unit = (com.bbn.tc.schema.avro.UUID)value$; break;
    case 1: dependentUnit = (com.bbn.tc.schema.avro.UUID)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.bbn.tc.schema.avro.UUID getUnit() {
    return unit;
  }
   ...
   */
  public void setUnit(com.bbn.tc.schema.avro.UUID value) {
    this.unit = value;
  }
   ...
   */
  public com.bbn.tc.schema.avro.UUID getDependentUnit() {
   ...
   * @param value the value to set.
   */
  public void setDependentUnit(com.bbn.tc.schema.avro.UUID value) {
   ...
   */
  public static com.bbn.tc.schema.avro.UnitDependency.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.UnitDependency.Builder();
  }
   ...
   * @return A new UnitDependency RecordBuilder
   */
  public static com.bbn.tc.schema.avro.UnitDependency.Builder newBuilder(com.bbn.tc.schema.avro.UnitDependency.Builder other) {
    return new com.bbn.tc.schema.avro.UnitDependency.Builder(other);
  }
   ...
   * @return A new UnitDependency RecordBuilder
   */
  public static com.bbn.tc.schema.avro.UnitDependency.Builder newBuilder(com.bbn.tc.schema.avro.UnitDependency other) {
    return new com.bbn.tc.schema.avro.UnitDependency.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UnitDependency>
    ...
    private com.bbn.tc.schema.avro.UUID unit;
    private com.bbn.tc.schema.avro.UUID dependentUnit;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.UnitDependency.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.UnitDependency other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.unit)) {
        this.unit = data().deepCopy(fields()[0].schema(), other.unit);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.UnitDependency.Builder setUnit(com.bbn.tc.schema.avro.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.UnitDependency.Builder clearUnit() {
      unit = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.UnitDependency.Builder setDependentUnit(com.bbn.tc.schema.avro.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.UnitDependency.Builder clearDependentUnit() {
      dependentUnit = null;
    ...
    public UnitDependency build() {
      try {
        ...
        record.unit = fieldSetFlags()[0] ? this.unit : (com.bbn.tc.schema.avro.UUID) defaultValue(fields()[0]);
        record.dependentUnit = fieldSetFlags()[1] ? this.dependentUnit : (com.bbn.tc.schema.avro.UUID) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
