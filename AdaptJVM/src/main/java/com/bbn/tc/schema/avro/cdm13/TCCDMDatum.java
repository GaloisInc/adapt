...
public class TCCDMDatum extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public TCCDMDatum(java.lang.Object datum, java.lang.CharSequence CDMVersion) {
    this.datum = datum;
   ...
   */
  public static com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder();
  }
   ...
   * @return A new TCCDMDatum RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder newBuilder(com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder other) {
    return new com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder(other);
  }
   ...
   * @return A new TCCDMDatum RecordBuilder
   */
  public static com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder newBuilder(com.bbn.tc.schema.avro.cdm13.TCCDMDatum other) {
    return new com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TCCDMDatum>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.cdm13.TCCDMDatum other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.datum)) {
        this.datum = data().deepCopy(fields()[0].schema(), other.datum);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder setDatum(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder clearDatum() {
      datum = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder setCDMVersion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.cdm13.TCCDMDatum.Builder clearCDMVersion() {
      CDMVersion = null;
