...
public class SrcSinkObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public SrcSinkType type;
   ...
   */
  public SrcSinkObject(UUID uuid, AbstractObject baseObject, SrcSinkType type) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: type = (SrcSinkType)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setType(SrcSinkType value) {
    this.type = value;
  }
   ...
   */
  public static SrcSinkObject.Builder newBuilder() {
    return new SrcSinkObject.Builder();
  }
   ...
   * @return A new SrcSinkObject RecordBuilder
   */
  public static SrcSinkObject.Builder newBuilder(SrcSinkObject.Builder other) {
    return new SrcSinkObject.Builder(other);
  }
   ...
   * @return A new SrcSinkObject RecordBuilder
   */
  public static SrcSinkObject.Builder newBuilder(SrcSinkObject other) {
    return new SrcSinkObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SrcSinkObject>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(SrcSinkObject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(SrcSinkObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public SrcSinkObject.Builder setUuid(UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SrcSinkObject.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SrcSinkObject.Builder setBaseObject(AbstractObject value) {
     ...
     * @return This builder.
     */
    public SrcSinkObject.Builder setBaseObjectBuilder(AbstractObject.Builder value) {
      clearBaseObject();
    ...
    /**
      ...
      * @return This builder.
      */
    public SrcSinkObject.Builder clearBaseObject() {
      baseObject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SrcSinkObject.Builder setType(SrcSinkType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SrcSinkObject.Builder clearType() {
      type = null;
    ...
    public SrcSinkObject build() {
      try {
        ...
        record.type = fieldSetFlags()[2] ? this.type : (SrcSinkType) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
