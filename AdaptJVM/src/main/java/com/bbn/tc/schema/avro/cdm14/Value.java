...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public ValueType type;
  ...
  @Deprecated public ValueDataType valueDataType;
  ...
  @Deprecated public java.util.List<TagRunLengthTuple> tag;
  /** A complex value might comprise other component values if needed (Optional) */
  @Deprecated public java.util.List<Value> components;
   ...
   */
  public Value(java.lang.Integer size, ValueType type, ValueDataType valueDataType, java.lang.Boolean isNull, java.lang.CharSequence name, java.lang.CharSequence runtimeDataType, java.nio.ByteBuffer valueBytes, java.util.List<TagRunLengthTuple> tag, java.util.List<Value> components) {
    this.size = size;
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: type = (ValueType)value$; break;
    case 2: valueDataType = (ValueDataType)value$; break;
    ...
    case 7: tag = (java.util.List<TagRunLengthTuple>)value$; break;
    case 8: components = (java.util.List<Value>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setValueDataType(ValueDataType value) {
   ...
   * @return * The value's tag expression describing its provenance (Optional)
         * Since value could be an array, the tag can use run length encoding if needed.
   */
  public java.util.List<TagRunLengthTuple> getTag() {
    return tag;
  }
   ...
   * @param value the value to set.
   */
  public void setTag(java.util.List<TagRunLengthTuple> value) {
    this.tag = value;
  }
   ...
   */
  public java.util.List<Value> getComponents() {
    return components;
  }
   ...
   * @param value the value to set.
   */
  public void setComponents(java.util.List<Value> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
    ...
    /** * The value's tag expression describing its provenance (Optional)
         * Since value could be an array, the tag can use run length encoding if needed. */
    private java.util.List<TagRunLengthTuple> tag;
    /** A complex value might comprise other component values if needed (Optional) */
    private java.util.List<Value> components;
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder setSize(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder clearSize() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder setType(ValueType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder setValueDataType(ValueDataType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder clearValueDataType() {
      valueDataType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder setRuntimeDataType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder clearRuntimeDataType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder setValueBytes(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder clearValueBytes() {
      valueBytes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder setTag(java.util.List<TagRunLengthTuple> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder setComponents(java.util.List<Value> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Value.Builder clearComponents() {
      components = null;
    ...
    public Value build() {
      try {
        ...
        record.type = fieldSetFlags()[1] ? this.type : (ValueType) defaultValue(fields()[1]);
        record.valueDataType = fieldSetFlags()[2] ? this.valueDataType : (ValueDataType) defaultValue(fields()[2]);
        ...
        record.tag = fieldSetFlags()[7] ? this.tag : (java.util.List<TagRunLengthTuple>) defaultValue(fields()[7]);
        record.components = fieldSetFlags()[8] ? this.components : (java.util.List<Value>) defaultValue(fields()[8]);
        return record;
      } catch (Exception e) {
