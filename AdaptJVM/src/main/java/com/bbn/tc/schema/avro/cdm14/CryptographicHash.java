...
public class CryptographicHash extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public CryptoHashType type;
   ...
   */
  public CryptographicHash(CryptoHashType type, java.lang.CharSequence hash) {
    this.type = type;
    this.hash = hash;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (CryptoHashType)value$; break;
   ...
   */
  public void setType(CryptoHashType value) {
    this.type = value;
  }
   ...
   */
  public static CryptographicHash.Builder newBuilder() {
    return new CryptographicHash.Builder();
  }
   ...
   * @return A new CryptographicHash RecordBuilder
   */
  public static CryptographicHash.Builder newBuilder(CryptographicHash.Builder other) {
    return new CryptographicHash.Builder(other);
  }
   ...
   * @return A new CryptographicHash RecordBuilder
   */
  public static CryptographicHash.Builder newBuilder(CryptographicHash other) {
    return new CryptographicHash.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CryptographicHash>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(CryptographicHash.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(CryptographicHash other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public CryptographicHash.Builder setType(CryptoHashType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CryptographicHash.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CryptographicHash.Builder setHash(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CryptographicHash.Builder clearHash() {
      hash = null;
    ...
    public CryptographicHash build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (CryptoHashType) defaultValue(fields()[0]);
