...
public class FileObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<CryptographicHash> hashes;
   ...
   */
  public FileObject(UUID uuid, AbstractObject baseObject, java.lang.Integer fileDescriptor, UUID localPrincipal, java.lang.Long size, java.lang.CharSequence peInfo, java.util.List<CryptographicHash> hashes) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: localPrincipal = (UUID)value$; break;
    case 4: size = (java.lang.Long)value$; break;
    case 5: peInfo = (java.lang.CharSequence)value$; break;
    case 6: hashes = (java.util.List<CryptographicHash>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<CryptographicHash> getHashes() {
    return hashes;
  }
   ...
   * @param value the value to set.
   */
  public void setHashes(java.util.List<CryptographicHash> value) {
    this.hashes = value;
  }
   ...
   */
  public static FileObject.Builder newBuilder() {
   ...
   * @return A new FileObject RecordBuilder
   */
  public static FileObject.Builder newBuilder(FileObject.Builder other) {
    return new FileObject.Builder(other);
  }
   ...
   * @return A new FileObject RecordBuilder
   */
  public static FileObject.Builder newBuilder(FileObject other) {
    return new FileObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FileObject>
    ...
    /** (Optional) Zero or more cryptographic hashes over the FileObject */
    private java.util.List<CryptographicHash> hashes;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(FileObject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(FileObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder setUuid(UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder setBaseObject(AbstractObject value) {
     ...
     * @return This builder.
     */
    public FileObject.Builder setBaseObjectBuilder(AbstractObject.Builder value) {
      clearBaseObject();
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder clearBaseObject() {
      baseObject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder setFileDescriptor(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder clearFileDescriptor() {
      fileDescriptor = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder setLocalPrincipal(UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder clearLocalPrincipal() {
      localPrincipal = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder setSize(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder setPeInfo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder clearPeInfo() {
      peInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder setHashes(java.util.List<CryptographicHash> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FileObject.Builder clearHashes() {
      hashes = null;
    ...
    public FileObject build() {
      try {
        ...
        record.localPrincipal = fieldSetFlags()[3] ? this.localPrincipal : (UUID) defaultValue(fields()[3]);
        ...
        record.hashes = fieldSetFlags()[6] ? this.hashes : (java.util.List<CryptographicHash>) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {
