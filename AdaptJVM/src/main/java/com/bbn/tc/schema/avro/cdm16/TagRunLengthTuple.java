...
public class TagRunLengthTuple extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public TagRunLengthTuple(java.lang.Integer numValueElements, com.bbn.tc.schema.avro.UUID tagId) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: tagId = (com.bbn.tc.schema.avro.UUID)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static com.bbn.tc.schema.avro.TagRunLengthTuple.Builder newBuilder() {
    return new com.bbn.tc.schema.avro.TagRunLengthTuple.Builder();
  }
   ...
   * @return A new TagRunLengthTuple RecordBuilder
   */
  public static com.bbn.tc.schema.avro.TagRunLengthTuple.Builder newBuilder(com.bbn.tc.schema.avro.TagRunLengthTuple.Builder other) {
    return new com.bbn.tc.schema.avro.TagRunLengthTuple.Builder(other);
  }
   ...
   * @return A new TagRunLengthTuple RecordBuilder
   */
  public static com.bbn.tc.schema.avro.TagRunLengthTuple.Builder newBuilder(com.bbn.tc.schema.avro.TagRunLengthTuple other) {
    return new com.bbn.tc.schema.avro.TagRunLengthTuple.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TagRunLengthTuple>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bbn.tc.schema.avro.TagRunLengthTuple.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bbn.tc.schema.avro.TagRunLengthTuple other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.numValueElements)) {
        this.numValueElements = data().deepCopy(fields()[0].schema(), other.numValueElements);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.TagRunLengthTuple.Builder setNumValueElements(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.TagRunLengthTuple.Builder clearNumValueElements() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.TagRunLengthTuple.Builder setTagId(com.bbn.tc.schema.avro.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bbn.tc.schema.avro.TagRunLengthTuple.Builder clearTagId() {
      tagId = null;
    ...
    public TagRunLengthTuple build() {
      try {
        ...
        record.tagId = fieldSetFlags()[1] ? this.tagId : (com.bbn.tc.schema.avro.UUID) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
