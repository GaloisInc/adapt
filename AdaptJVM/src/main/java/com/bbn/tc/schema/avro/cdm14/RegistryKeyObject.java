...
public class RegistryKeyObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public RegistryKeyObject(UUID uuid, AbstractObject baseObject, java.lang.CharSequence key, Value value, java.lang.Long size) {
    this.uuid = uuid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: value = (Value)value$; break;
   ...
   */
  public static RegistryKeyObject.Builder newBuilder() {
    return new RegistryKeyObject.Builder();
  }
   ...
   * @return A new RegistryKeyObject RecordBuilder
   */
  public static RegistryKeyObject.Builder newBuilder(RegistryKeyObject.Builder other) {
    return new RegistryKeyObject.Builder(other);
  }
   ...
   * @return A new RegistryKeyObject RecordBuilder
   */
  public static RegistryKeyObject.Builder newBuilder(RegistryKeyObject other) {
    return new RegistryKeyObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RegistryKeyObject>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(RegistryKeyObject.Builder other) {
      super(other);
      ...
      if (other.hasValueBuilder()) {
        this.valueBuilder = Value.newBuilder(other.getValueBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(RegistryKeyObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder setUuid(UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder setBaseObject(AbstractObject value) {
     ...
     * @return This builder.
     */
    public RegistryKeyObject.Builder setBaseObjectBuilder(AbstractObject.Builder value) {
      clearBaseObject();
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder clearBaseObject() {
      baseObject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder setKey(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder clearKey() {
      key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder setValue(Value value) {
    ...
    public Value.Builder getValueBuilder() {
      if (valueBuilder == null) {
        if (hasValue()) {
          setValueBuilder(Value.newBuilder(value));
        } else {
          setValueBuilder(Value.newBuilder());
        }
      }
      return valueBuilder;
    }
     ...
     * @return This builder.
     */
    public RegistryKeyObject.Builder setValueBuilder(Value.Builder value) {
      clearValue();
      valueBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder clearValue() {
      value = null;
      valueBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder setSize(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public RegistryKeyObject.Builder clearSize() {
      size = null;
    ...
    public RegistryKeyObject build() {
      try {
        ...
        if (valueBuilder != null) {
          ...
          record.value = fieldSetFlags()[3] ? this.value : (Value) defaultValue(fields()[3]);
        }
