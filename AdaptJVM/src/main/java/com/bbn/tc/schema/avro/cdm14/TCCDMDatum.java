...
public class TCCDMDatum extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static TCCDMDatum.Builder newBuilder() {
    return new TCCDMDatum.Builder();
  }
   ...
   * @return A new TCCDMDatum RecordBuilder
   */
  public static TCCDMDatum.Builder newBuilder(TCCDMDatum.Builder other) {
    return new TCCDMDatum.Builder(other);
  }
   ...
   * @return A new TCCDMDatum RecordBuilder
   */
  public static TCCDMDatum.Builder newBuilder(TCCDMDatum other) {
    return new TCCDMDatum.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TCCDMDatum>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(TCCDMDatum.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(TCCDMDatum other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.datum)) {
        this.datum = data().deepCopy(fields()[0].schema(), other.datum);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public TCCDMDatum.Builder setDatum(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public TCCDMDatum.Builder clearDatum() {
      datum = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public TCCDMDatum.Builder setCDMVersion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public TCCDMDatum.Builder clearCDMVersion() {
      CDMVersion = null;
