...
trait CustomEnum[T] extends CDM15 {
  val values: Seq[T]
...
sealed trait SubjectType extends CDM15
...
sealed trait PrivilegeLevel extends CDM15
...
sealed trait SrcSinkType extends CDM15
...
sealed trait InstrumentationSource extends CDM15
...
sealed trait PrincipalType extends CDM15
...
sealed trait EventType extends CDM15
case object EventType extends CustomEnum[EventType] { val values = Seq(EVENT_ACCEPT, EVENT_BIND, EVENT_BLIND, EVENT_CHANGE_PRINCIPAL, EVENT_CHECK_FILE_ATTRIBUTES, EVENT_CLONE, EVENT_CLOSE, EVENT_CONNECT, EVENT_CREATE_OBJECT, EVENT_CREATE_THREAD, EVENT_DUP, EVENT_EXECUTE, EVENT_FNCTL, EVENT_FORK, EVENT_LINK, EVENT_LSEEK, EVENT_MMAP, EVENT_MODIFY_FILE_ATTRIBUTES, EVENT_MPROTECT, EVENT_OPEN, EVENT_OTHER, EVENT_READ, EVENT_RECVFROM, EVENT_RECVMSG, EVENT_RENAME, EVENT_SENDTO, EVENT_SENDMSG, EVENT_SHM, EVENT_SIGNAL, EVENT_TRUNCATE, EVENT_UNIT, EVENT_UNLINK, EVENT_WAIT, EVENT_WRITE, EVENT_EXIT, EVENT_LOADLIBRARY, EVENT_BOOT, EVENT_LOGCLEAR, EVENT_MOUNT, EVENT_STARTSERVICE, EVENT_LOGIN, EVENT_LOGOUT) }
...
sealed trait FileObjectType extends CDM15
...
sealed trait ValueType extends CDM15
...
sealed trait ValueDataType extends CDM15
...
sealed trait TagOpCode extends CDM15
...
sealed trait IntegrityTag extends CDM15
...
sealed trait ConfidentialityTag extends CDM15
...
sealed trait CryptoHashType extends CDM15
